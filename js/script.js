...
function handleFormSubmit(e) {
    ...
    if (isNaN(hours) || hours <= 0 || description === '') {
        alert("Tarkista tuntimäärä!");
        return;
    }
...
function updateSummary() {
    ...
    // LUO JA TÄYDENTÄÄ YHTEENVETO-OBJEKTIA KAIKILLA TALLENNETUILLA ENTRIES-OBJEKTEILLA
    ...
    // NÄYTTÄÄ TAI PIILETTÄÄ YHTEENVEDON SEN MUKAAN, ONKO TALLETUKSIA
    if(entries.length > 0) {
